...
%install
mkdir -p %{buildroot}%{_libexecdir}/soda %{buildroot}%{_bindir} %{buildroot}%{_unitdir} %{buildroot}%{_unitdir}/getty@tty1.service.d %{buildroot}%{_presetdir} %{buildroot}%{_sysctldir} %{buildroot}%{_sysconfdir}/firewalld %{buildroot}%{_sysconfdir}/profile.d %{buildroot}%{_sysconfdir}/cloud/cloud.cfg.d
