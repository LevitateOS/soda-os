...
Requires:       cockpit-system, cockpit-ws, coreutils, git-core, glibc-common, openssh-clients, pam, policycoreutils, polkit, procps-ng, shadow-utils, soda-forgejo, systemd, util-linux
