...
export const brandingSources: Record<string, string> = {
  ...
  "login-background-light.svg": "assets/branding/cockpit/login-background-light.svg",
  "login-background-dark.svg": "assets/branding/cockpit/login-background-dark.svg",
  "favicon.ico": "assets/branding/cockpit/favicon.ico",
  "apple-touch-icon.png": "assets/branding/cockpit/apple-touch-icon.png",
};
