...
test.each([
  ...
  ["pages/UpdatesPage.tsx", "organisms/updates/TrackedImageSection.tsx", true],
  ["pages/UpdatesPage.tsx", "updates/store.ts", true],
  ["organisms/updates/TrackedImageSection.tsx", "updates/status.ts", true],
  ["molecules/updates/UpdateFeedback.tsx", "molecules/DiagnosticAlert.tsx", true],
  ["organisms/updates/TrackedImageSection.tsx", "updates/native.ts", false],
