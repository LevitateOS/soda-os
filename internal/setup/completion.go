...
const (
	DefaultCompletionPath = "/var/lib/soda/setup-complete"
	completionContents    = "dismissed\n"
)

// FileCompletion records only the user's explicit request to stop automatic
// console Setup. It does not describe account or network readiness.
