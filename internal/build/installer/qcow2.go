...
func (b *Builder) compressQCOW2(ctx context.Context, input qcow2Input) (QCOW2Result, error) {
	...
	if err := b.runner.Run(ctx, process.Command{Dir: b.Root, Name: "zstd", Args: []string{"--quiet", "--no-progress", "--threads=1", "--force", "--output", input.compressedPath, input.rawPath}}); err != nil {
