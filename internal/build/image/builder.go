...
func (b *Builder) validateBuildInputs() error {
	for _, path := range []string{"packaging/bootc/Containerfile", "packaging/builder/Containerfile", b.Spec.Platform.Builder.PackageLock, b.Spec.Platform.Installer.PackageLock, b.Spec.Platform.Installer.ToolLock, b.Spec.Platform.Installer.ISOConfig, "packaging/rpm/release/soda-release.spec", "packaging/rpm/runtime/soda-runtime.spec", "packaging/rpm/projects/soda-projects.spec", "packaging/rpm/forgejo/soda-forgejo.spec", "packaging/rpm/bun/soda-bun.spec", "packaging/rpm/bun/sources/LICENSE.md", "packaging/rpm/tea/soda-tea.spec", "packaging/rpm/tea/sources/LICENSE", "packaging/rpm/runtime/sources/sysusers/soda.conf", "distro/locks/forgejo-source.toml", "distro/locks/bun-source.toml", "distro/locks/tea-source.toml", "distro/toolset-commands.txt"} {
