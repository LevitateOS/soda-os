...
func (b *Builder) stageProductRPMSources(build, sources string) error {
	...
	files := [][2]string{
		...
		{b.path("assets/branding/source/soda-logo-horizontal.svg"), filepath.Join(sources, "soda-logo-horizontal.svg")},
		{b.path("assets/branding/source/soda-logo-horizontal-dark.svg"), filepath.Join(sources, "soda-logo-horizontal-dark.svg")},
		{b.path("assets/branding/theme/palette.css"), filepath.Join(sources, "soda-palette.css")},
		{b.path("cockpit/src/cockpit/theme.css"), filepath.Join(sources, "soda-cockpit-theme.css")},
		{b.path("assets/branding/cockpit/login-background-light.svg"), filepath.Join(sources, "soda-login-background-light.svg")},
		{b.path("assets/branding/cockpit/login-background-dark.svg"), filepath.Join(sources, "soda-login-background-dark.svg")},
		{b.path("assets/branding/cockpit/favicon.ico"), filepath.Join(sources, "soda-cockpit-favicon.ico")},
		{b.path("assets/branding/cockpit/apple-touch-icon.png"), filepath.Join(sources, "soda-cockpit-apple-touch-icon.png")},
